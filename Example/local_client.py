...
CLOUD_SERVER_URL = "https://emotion-ai-227351609312.us-central1.run.app" # For local testing, use localhost. For cloud, use your server's public IP/domain
...
def send_chat_message(user_input, current_emotion, server_url, chat_response_queue):
    ...
    try:
        ...
        chat_response_queue.put("Sorry, I couldn't connect to the chat server.")
    except Exception as e:
